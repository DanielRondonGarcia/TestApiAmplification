...
using TestApi.APIs.Dtos;
using TestApi.APIs.Errors;
using TestApi.APIs.Extensions;
...
{
    protected readonly TestApiDbContext _context;

    public UsersServiceBase(TestApiDbContext context)
    {
        _context = context;
    }
    ...
    public async Task<UserViewOutput> ViewUser(UserViewInput userViewInputDto)
    {
